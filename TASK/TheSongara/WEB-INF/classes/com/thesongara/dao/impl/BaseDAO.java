...
public abstract class BaseDAO<E extends Identifiable> implements IBaseDAO<E> {
	...
	private void prepareOrderByCriteria(Criteria criteria,final String[] columnNames, final Object[] columnValues, final String orderColumnName,
			final boolean isLikeFlag, final String orderType){
	...
	@Override
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<E> findColumnAndValueByOrderPagination(final String[] columnNames, final Object[] columnValues, final String orderColumnName,
