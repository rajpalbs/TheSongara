...
<div style="width:700px; float: right; font-family:Serif;">
	...
	<br>
	<label class="text"><spring:message code="label.chauhan.line1"/></label>
	<br>
	<br>
	&nbsp;&nbsp;
	<label class="text"><spring:message code="label.chauhan.line2"/></label>
	<br>
	<br>
	&nbsp;&nbsp;
	<label class="text"><spring:message code="label.chauhan.line3"/></label>
	<br>
	<br>
	&nbsp;&nbsp;
	<label class="text"><spring:message code="label.chauhan.line4"/></label>
	...
	<br>
	<label class="text"><spring:message code="label.songara.line1"/></label>
	<br>
	<br>
	&nbsp;&nbsp;
	<label class="text"><spring:message code="label.songara.line2"/></label>
	<br>
	<br>
	&nbsp;&nbsp;
	<label class="text"><spring:message code="label.songara.line3"/></label>
	<br>
	<br>
	<br>
