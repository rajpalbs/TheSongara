...
<div id="changePasswordDiv">
	<form id="changePassword" action="saveChangePassword.do" method="post">
		...
		<ul>
 			<li>
 				<label class="colouredLabel">Old<br>Password</label>
 				<input type="password" id="oldPassword" name="oldPassword" title="Enter Old Password" required>
 				<br>
 				<br>
 				<br>
 				<label class="colouredLabel">New<br>Password</label>
 				<input type="password" id="newPassword" name="newPassword" title="Enter New Password" required>
 				<br>
 				<br>
 				<label class="colouredLabel">Retype New<br>	Password</label>
 				<input type="password" id="confirmPassword" name="confirmPassword" title="Retype New Password" required>
 			</li>
 		</ul>
 		<button id="saveChangedPassword" style="margin-right: 385px">OK,Done</button>
