			...
			<ul>		
				<li><label class="colouredLabel">Name</label>
					<input type="text" id="surname" name="surname" style="width: 136px; text-transform:uppercase;" placeholder="Surname" required maxlength="8">
   					...
   					<input type="text" id="lastName" name="lastName" style="text-transform:uppercase;width: 212px;" placeholder="Father/Husband's Name" required maxlength="26">
   				</li>
   				<br>
   				<li><label class="colouredLabel">Contact Nos</label>
   					<input type="tel" id="countryCode1" name="countryCode1" style="width: 28px" value="+91" autocomplete="off" required maxlength="5" pattern="^[0-9,+]+$">
					<input type="tel" id="contact1" name="contact1" style="width: 192px" placeholder="Primary Phone Number" required maxlength="15" autocomplete="off" pattern="^[0-9,-]+$" >
   					&nbsp;
   					<label class="colouredLabel">&</label>
   					&nbsp;
   					<input type="tel" id="countryCode2" name="countryCode2" style="width: 28px" value="+91" autocomplete="off" required maxlength="5" pattern="^[0-9,+]+$">
					<input type="tel" id="contact2" name="contact2" style="width: 192px" placeholder="Secondary Phone Number" maxlength="15" autocomplete="off" pattern="^[0-9,-]+$">
   				</li>
   				<br>
   				<li>
   					...
   					<div style="float: right;">
   						...
   						<input type="text" id="dob" name="dob" class="datepicker" placeholder="dd/mm/yyyy" maxlength="10">
   					</div>
   				</li>
   				<br>
   				<li>
