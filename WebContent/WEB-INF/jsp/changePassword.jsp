...
<div style="padding-left:270px;">
	<form id="changePassword" action="saveChangePassword.do" method="post">
		<ul>
 			<li><label class="colouredLabel">Old Password</label>
 				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 				<input type="password" id="oldPassword" name="oldPassword" title="Enter Old Password" required>
 				<br>
 				<br>
 				<br>
 				<label class="colouredLabel">New Password</label>
 				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 				<input type="password" id="newPassword" name="newPassword" title="Enter New Password" required>
 				<br>
 				<br>
 				<label class="colouredLabel">Confirm Password</label>
 				<input type="password" id="confirmPassword" name="confirmPassword" title="Enter Confirm Password" required>
 			</li>
 		</ul>
 		<button id="saveChangedPassword" style="margin-right: 340px">Done</button>
